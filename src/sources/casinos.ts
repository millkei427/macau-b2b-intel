export interface MacauCasino {
  ...
  publicEmail?: string; // General business inquiry email (NOT direct procurement)
  vendorPortalUrl?: string; // Where vendors register
  website: string;
  note: string;
}
 ...
 */
export const MACAU_CASINOS: MacauCasino[] = [
  {
    id: "sands-china",
    name: "金沙中國",
...
export function fetchAllMacauCasinos(): MacauCasino[] {
